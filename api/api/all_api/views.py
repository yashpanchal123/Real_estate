...
def home(request):
    return HttpResponse('Api for real estate agents.')
...
class Agent_lists(ListCreateAPIView):
    queryset = actors.objects.all()
    permission_classes = [IsAuthenticated]
    serializer_class = actorSerializer
    pagination_class = MPN
    filter_backends = [DjangoFilterBackend]
    filterset_fields = ['id', 'Agent_URL', 'Agent_name', 'email', 'telephone', 'fax',
                        'office_contact', 'Mobile_no', 'website', 'Address', 'StreetAddress', 'city', 'state',
                        'zipcode', 'description', 'source', 'country']
